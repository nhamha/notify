    ...
    public class OTPAPIController : ControllerBase
    {
        ...
        public ActionResult<ResponseBuilder> ChangePassVerifyOTP([FromBody] OtpModel model)
        {
            try
            {
                ...
                string newPassEnc = Security.GetPasswordEncryp(data.NewPassWord, _accountSession.AccountName);
                string oldPassEnc = Security.GetPasswordEncryp(data.OldPassWord, _accountSession.AccountName);
